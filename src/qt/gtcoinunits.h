...
/** Gtcoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for dropdown selection boxes.
*/
class GtcoinUnits: public QAbstractListModel
{
public:
    explicit GtcoinUnits(QObject *parent);
...
typedef GtcoinUnits::Unit GtcoinUnit;
