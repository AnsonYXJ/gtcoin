...
Setup
-----
Unpack the files into a directory and run gtcoin-qt.exe.

If you have Microsoft Security Essentials, you need to add gtcoin.exe to its
"Excluded processes" list.  Microsoft Security Essentials->Settings tab,
select Excluded processes, press Add, select gtcoin.exe, OK, Save changes.
